      ...
      this.shadowRoot.innerHTML = `
        ...
        <div class="card">
          <div class="meta">
            ...
            <div class="status">${isAuthenticated ? labelAuthenticated : labelUnauthenticated}</div>
            <div class="hint">Access token: ${tokenHint}</div>
          </div>
          <div class="actions">
            ${isAuthenticated
              ? `<button type="button" class="secondary" data-action="logout">${labelLogout}</button>`
              : `<button type="button" class="primary" data-action="login">${labelLogin}</button>`}
          </div>
        </div>
      `;
