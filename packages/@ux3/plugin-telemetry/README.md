...
- Runtime observability and telemetry collection
- Pluggable backend provider support
- Batching and flush control
- Performance and diagnostics event capture

## Installation

```bash
npm install @ux3/plugin-telemetry
```

## Basic Usage

```ts
import PluginTelemetry from '@ux3/plugin-telemetry';
