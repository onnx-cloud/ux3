...
Mermaid diagram renderer for UX3 markdown

## Features

- Mermaid-style diagram rendering for UX3 markdown
- Responsive SVG output without eval
- Theme-aware styling and lazy rendering
- Automatic markdown code block integration

## Installation

```bash
npm install @ux3/ux-diagrams
```

## Basic Usage

```ts
import UxDiagrams from '@ux3/ux-diagrams';
