...
- The `ux/widget/hello.yaml` is the minimal working example — one FSM with `index` state and inline context.
- The starter view uses `context:` to declare initial state and `actions:` to update on events.
