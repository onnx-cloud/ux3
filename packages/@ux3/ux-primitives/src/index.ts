...
export { registerWidget, resolveWidgetMetadata, getRegisteredWidgets, clearWidgetRegistry, getWidgetsByFamily } from '../../../../src/ui/widget/widget-registry.js';
export type { WidgetMetadata } from '../../../../src/ui/widget/widget-registry.js';
import { registerBuiltInPrimitives as _registerBuiltInPrimitives } from '../../../../src/ui/widget/primitives/index.js';
export { _registerBuiltInPrimitives as registerBuiltInPrimitives };

function registerCoreWidgets(): void {
  if (typeof window === 'undefined') return;
  if ((window as any).__ux3CoreWidgetsRegistered) return;
  _registerBuiltInPrimitives();
