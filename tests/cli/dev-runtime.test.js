...
describe('dev command runtime info', () => {
    it('generates runtime bundle and style paths', async () => {
        ...
        await fs.writeFile(path.join(temp, 'generated', 'types.ts'), 'export type Routes = any; export type Services = any; export type I18n = any;');
        ...
        for (const f of files)
            if (f.endsWith('.css'))
                styles.push(path.join(path.relative(temp, outputDir), f));
...
//# sourceMappingURL=dev-runtime.test.js.map