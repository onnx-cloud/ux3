...
import { ServiceContainer } from '@ux3/services/container';
describe('ServiceContainer - Comprehensive Tests', () => {
    ...
    describe('Service Registration', () => {
        ...
        it('should support fluent chaining', () => {
            const service1 = { call: vi.fn() };
            const service2 = { call: vi.fn() };
        ...
        it('should handle multiple service types', () => {
            const httpService = { call: vi.fn() };
            const wsService = { call: vi.fn() };
            const mockService = { call: vi.fn() };
            container
    ...
    describe('Service Calls', () => {
        ...
        it('should throw for nonexistent service', async () => {
            await expect(container.call('nonexistent', 'GET', {})).rejects.toThrow('Service not found');
        });
    ...
    describe('Telemetry', () => {
        ...
        it('should emit to window.__ux3Telemetry', async () => {
            const originalTelemetry = window.__ux3Telemetry;
            window.__ux3Telemetry = vi.fn();
            const service = {
                call: vi.fn().mockResolvedValue('data'),
            };
            container.register('api', service);
            ...
            expect(window.__ux3Telemetry).toBeDefined();
            window.__ux3Telemetry = originalTelemetry;
        });
    });
    describe('Real-world Scenarios', () => {
        it('should handle REST API service', async () => {
            ...
            expect(postResult.data.name).toBe('new');
        });
        it('should handle authentication service', async () => {
            ...
            expect(login.data.token).toBe('abc123');
    ...
    describe('Edge Cases', () => {
        ...
        it('should handle null parameters', async () => {
            ...
            container.register('api', service);
            const result = await container.call('api', 'GET', null);
            expect(result).toBeDefined();
        });
        it('should handle undefined parameters', async () => {
            ...
            container.register('api', service);
            const result = await container.call('api', 'GET', undefined);
            expect(result).toBeDefined();
        });
